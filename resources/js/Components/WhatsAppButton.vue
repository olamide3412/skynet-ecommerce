...
const supportPhone = usePage().props.store_settings?.company_phone || '';


const tradeNowLink = computed(() => {
    // return generateWhatappLink(support.phone_whatsapp, 'Hi, I need your services?');
    return generateWhatappLink(supportPhone.replace('+', ''), 'Hello');
})
</script>
